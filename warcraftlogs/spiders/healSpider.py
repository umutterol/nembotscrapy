...
class HealspiderSpider(scrapy.Spider):
    name = 'healSpider'
    allowed_domains = ['https://www.warcraftlogs.com/rankings/guild-rankings-for-zone/255536/hps/21/0/4/10/1/Any/Any/rankings/historical/0/best/0/0']
